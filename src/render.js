...
<footer class="footer">
  <div class="footer__inner">
    <p class="footer__cta">Building something that needs true creative systems behind it?<br><br><span class="footer__reach">Reach out: <a href="mailto:${e(email)}">${e(email)}</a></span></p>
